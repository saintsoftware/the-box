...
void rectangle(){
	0,30,639,450
	int x, int y, int width, int height, bool fill, int colorindex
}

void line(){
	int x1, int y1, int x2, int y2, int colorindex
}
...
void pixmap(GdkPixmap *pixmap, int x, int y, int width, int height);
